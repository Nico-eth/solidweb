...
const features = [
  'Platform-specific optimization (DEXtools, Coinmarketcap, DEXScreener, Geckoterminal, etc.)',
  'Natural-looking interaction',
  'Track chart rise',
  'Upvote campaigns',
  'Helps you rise in trend lists and rankings',
  'Customizable for your project'
];

const TrendingUpvoteBotsPage = () => {
      ...
      <main className="min-h-screen py-32 bg-white dark:bg-gray-900">
        <div className="container-custom max-w-2xl mx-auto">
          ...
          <div className={`flex flex-col items-center text-center mb-8 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{ transitionDelay: '250ms' }}>
            <Rocket className="w-16 h-16 text-yellow-500 mb-4" />
            <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">Trending-Upvote Bots</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
              Bots designed to highlight your project on popular crypto platforms. Helps you rise in trend lists and rankings on platforms like DEXtools, Coinmarketcap, DEXScreener, Geckoterminal, and more. Increase your token's exposure by automating upvotes and trending actions.
            </p>
          </div>
...
export default TrendingUpvoteBotsPage; 