...
const features = [
  ...
  'Multiple buying strategies',
  'Instantly detect and buy newly launched tokens'
];

const SolanaSniperBotPage = () => {
      ...
      <main className="min-h-screen py-32 bg-white dark:bg-gray-900">
        <div className="container-custom max-w-2xl mx-auto">
          ...
          <div className={`flex flex-col items-center text-center mb-8 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{ transitionDelay: '250ms' }}>
            <Crosshair className="w-16 h-16 text-gray-700 mb-4" />
            <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">Solana Sniper Bot</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
              A sniper bot that can instantly detect and quickly buy newly launched tokens on the Solana network. Allows you to be among the first buyers and catch potential opportunities with advanced filtering and anti-scam features.
            </p>
          </div>
...
export default SolanaSniperBotPage; 