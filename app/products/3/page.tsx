...
const features = [
  'Telegram DM, Forwarder, Shill',
  'Instagram DM, Like, Comment',
  'Discord DM',
  'Twitter Comment, Shill, DM, Auto Tweet',
  'Comprehensive automation for marketing activities',
  'Group copying and message forwarding'
];

const MarketingBotsPage = () => {
      ...
      <main className="min-h-screen py-32 bg-white dark:bg-gray-900">
        <div className="container-custom max-w-2xl mx-auto">
          ...
          <div className={`flex flex-col items-center text-center mb-8 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{ transitionDelay: '250ms' }}>
            ...
            <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">Marketing Bots</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
              Comprehensive bot package that automates your marketing activities on social media platforms. DM sending, message forwarding, group copying, and more for Telegram, Instagram, Discord, and Twitter.
            </p>
          </div>
...
export default MarketingBotsPage; 