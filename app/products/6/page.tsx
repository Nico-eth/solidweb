...
const TelegramCustomBuyBotPage = () => {
      ...
      <main className="min-h-screen py-32 bg-white dark:bg-gray-900">
        <div className="container-custom max-w-2xl mx-auto">
          ...
          <div className={`flex flex-col items-center text-center mb-8 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`} style={{ transitionDelay: '250ms' }}>
            ...
            <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">Telegram Custom Buy Bot</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-xl">
              Custom Telegram bots for seamless token purchases, tailored to your project's needs. Display alerts to buyers, increase engagement, and help build community with fully customizable bots.
            </p>
          </div>
...
export default TelegramCustomBuyBotPage; 